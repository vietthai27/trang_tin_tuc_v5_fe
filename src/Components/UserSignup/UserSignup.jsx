...
import { changeEmailSignup, changePasswordSignup, changeRetypePasswordSignup, changeUsernameSignup, userSignupRequest } from './reducer';
...
function UserSignup() {
  ...
  const handleSignup = () => {
    if (userDataSignup.username === "" || userDataSignup.username === null) {
      ...
      dispatch(userSignupRequest(userDataSignup))
    }
  }
